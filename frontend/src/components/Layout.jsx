...
function Layout() {
  ...
  // Display role without ROLE_ prefix
  ...
  return (
    <div
      className="d-flex flex-column min-h-screen"
      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-dark sticky-top shadow-sm px-3">
        <div className="container-fluid">
          ...
          >
            ...
            <span className="text-white ms-2 fw-light fs-6">
              HR Portal
            </span>
          </Link>
          ...
          <div className="d-flex align-items-center ms-auto">
            ...
            <Link
              to="/notifications"
              className="btn btn-dark btn-sm me-3 position-relative border-0"

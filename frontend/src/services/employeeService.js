...
export const getEmployees = () =>
    axios.get(EMPLOYEES_URL, authHeader());

export const addEmployee = (employee) =>
    axios.post(EMPLOYEES_URL, employee, authHeader());

export const updateEmployee = (id, employee) =>
    axios.put(`${EMPLOYEES_URL}/${id}`, employee, authHeader());


export const deleteEmployee = (id) =>
    axios.delete(`${EMPLOYEES_URL}/${id}`, authHeader());

export const searchEmployee = (name) =>
    axios.get(`${EMPLOYEES_URL}/search?name=${name}`, authHeader());

export const getEmployeeById = (id) =>
    axios.get(`${EMPLOYEES_URL}/${id}`, authHeader());

export const getEmployeesPage = (page, size) =>
    axios.get(`${EMPLOYEES_URL}/page?page=${page}&size=${size}`, authHeader());
